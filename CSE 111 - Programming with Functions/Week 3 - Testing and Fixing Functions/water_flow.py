...
EARTH_ACCELERATION_OF_GRAVITY = 9.8066500 # Earth's acceleration of gravity
WATER_DYNAMIC_VISCOSITY = 0.0010016 # Dynamic viscosity of water
...
def pressure_gain_from_water_height(height):
    #TODO:
    return (height * WATER_DENSITY * EARTH_ACCELERATION_OF_GRAVITY) / 1000
